...
namespace fmo {
    ...
    private:
        ...
        struct ProtoStrip : public StripRepr {
            using StripRepr::StripRepr;
        };

        /// Strip generated by merging ProtoStrips from two consecutive frames.
        struct MetaStrip : public StripRepr {
            enum : int16_t {
            ...
            MetaStrip(const ProtoStrip& strip, bool aNewer)
                : StripRepr(strip), older(!aNewer), newer(aNewer), motion(0) {}
            ...
            MetaStrip(const ProtoStrip& aNewer, const ProtoStrip& aOlder)
                : StripRepr(Pos16(aNewer.pos.x, (aNewer.pos.y + aOlder.pos.y) / 2),
